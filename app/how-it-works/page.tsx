    ...
    <main className="min-h-screen bg-white pt-20">
        ...
        <div className="container-main max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              How We Resolve Your{" "}
              <span className="text-blue-700">Insurance Dispute</span>
            </h1>
      ...
      <SectionWrapper className="bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {steps.map((step, index) => (
            <div
              key={step.title}
              className="group relative bg-white rounded-2xl border-2 border-slate-100 p-6 md:p-8 hover:border-blue-200 hover:shadow-xl transition-all duration-300"
            >
              <div className="absolute -top-4 -right-4 w-12 h-12 bg-blue-900 text-white rounded-full flex items-center justify-center text-lg font-bold shadow-lg">
                {index + 1}
              </div>
              <div className="w-14 h-14 rounded-2xl bg-blue-50 text-blue-700 flex items-center justify-center mb-5 transition-transform group-hover:scale-110">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {timeline.map((t) => (
              ...
              >
                <span className="inline-block bg-blue-900 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">
                  {t.phase}
                </span>
      ...
      <SectionWrapper className="bg-white">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-3xl p-8 md:p-10 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/services/"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-blue-900 font-semibold rounded-lg hover:bg-blue-50 transition-colors w-full mt-8 text-center"
              >
