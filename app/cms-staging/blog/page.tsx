      ...
      <main className="min-h-screen bg-slate-50/50 pt-20">
        <div className="border-b border-amber-300 bg-amber-50">
          <div className="container-main px-4 py-3 text-sm text-amber-950">
            <strong>CMS staging parity:</strong> noindex · Sanity migration dataset · public /blog/ remains legacy.
          </div>
        </div>
        ...
        <div className="container-main px-4 py-12 md:py-16">
          <div className="mb-8 rounded-xl border border-slate-200 bg-white p-4 text-sm text-slate-600">
            Sanity order currently follows <code>publishedAt desc</code>. Phase 6 verification compares this sequence with the legacy archive before any cutover.
          </div>
